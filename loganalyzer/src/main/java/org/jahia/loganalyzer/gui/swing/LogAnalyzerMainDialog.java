...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public LogAnalyzerMainDialog(JahiaLogAnalyzer jahiaLogAnalyzer) {
        this.jahiaLogAnalyzer = jahiaLogAnalyzer;

        if (jahiaLogAnalyzer.getBuildTimestamp() != null) {
            setTitle("Jahia Log Analysis Tool v" + jahiaLogAnalyzer.getVersion() + " build " + jahiaLogAnalyzer.getBuildTimestamp());
        } else {
            setTitle("Jahia Log Analysis Tool v" + jahiaLogAnalyzer.getVersion() + " build " + jahiaLogAnalyzer.getBuildNumber());
        }
...
// call onCancel() on ESCAPE
        ...
        LogParserConfiguration logParserConfiguration = jahiaLogAnalyzer.getLogParserConfiguration();
        try {
    ...
    class AnalysisWorker extends Thread {
        ...
        public void run() {
            try {
                jahiaLogAnalyzer.analyze(LogAnalyzerMainDialog.this);
